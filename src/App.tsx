    ...
    <div className={"app " + (rtl ? "rtl" : "ltr")}>
      ...
      <main>
        ...
        <section id="shop" className="shop">
          ...
          <div className="shopHead"><div className="viewToggle" aria-label="View mode"><button className={viewMode===1?"active":""} aria-label="Single column view" onClick={()=>setViewMode(1)}><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="4" width="16" height="16" rx="2"/><path d="M8 4v16"/></svg></button><button className={viewMode===2?"active":""} aria-label="Grid view" onClick={()=>setViewMode(2)}><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="4" width="6" height="6" rx="1"/><rect x="14" y="4" width="6" height="6" rx="1"/><rect x="4" y="14" width="6" height="6" rx="1"/><rect x="14" y="14" width="6" height="6" rx="1"/></svg></button></div></div>
